...
<head>
  ...
  <title>Product - GMN Dashboard</title>
          ...
          <div class="card">
            <div class="card-body">
              <div class="d-flex align-items-center justify-content-between">
                ...
                <a href="">
                  <a href="/dashboard/products" class="fs-6" style="color: #E68924;;">Back</a>
                </a>
              </div>
              ...
              <form method="POST" action="/dashboard/products/edit/{{ $product->id }}" enctype="multipart/form-data">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    ...
                    <textarea class="form-control" id="body" placeholder="Enter the Description" name="body" style="width: 100%;" required>{{ $product->body }}</textarea>
